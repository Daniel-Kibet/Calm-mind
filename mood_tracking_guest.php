...
// Fetch moods associated with the guest user (no user_id for guests)
$query = "SELECT * FROM moods WHERE user_id IS NULL ORDER BY date DESC";
...
<head>
    ...
    <title>Manage Your Moods - Guest</title>
...
<div class="content-container">
    <h2>Your Mood Tracking - Guest</h2>
    ...
    <table>
        ...
        <?php else: ?>
            <tr>
                <td colspan="4">No mood entries found.</td>
            </tr>
        <?php endif; ?>
    </table>
